"""Fallback copy of ComfyUI core MiniMax H3 conditioning helpers.

Upstream source (preferred import target):
  comfy_extras/nodes_minimax_h3.py in Comfy-Org/ComfyUI
  https://github.com/Comfy-Org/ComfyUI/blob/master/comfy_extras/nodes_minimax_h3.py

Thanks to Comfy-Org / ComfyUI (PR #15224). Used only when the core module
cannot be imported; not registered as pack nodes.
"""
